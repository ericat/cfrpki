...
var (
	...
	CorsOrigins  = flag.String("cors.origins", "rpki.cloudflare.com", "Cors origins separated by comma")
	CorsCreds    = flag.Bool("cors.creds", true, "Cors enable credentials")
	CorsInsecure = flag.Bool("cors.insecure", false, "Cors enable returning any origin")
